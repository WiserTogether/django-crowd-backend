...
version = __import__('django_crowd').__version__

setup(
    name='django-crowd',
    version=version,
    description='Crowd Authentication for Django',
    long_description="""django-crowd implements a crowd authentication 
    backend for django. See the README.mkd for more details.
    """,
    author='Sebastian Annies',
    author_email='bitbucket.org/sannies',
    maintainer='Erik LaBianca',
    maintainer_email='erik.labianca@gmail.com',
    url='http://github.com/easel/django-crowd',
